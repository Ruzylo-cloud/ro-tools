        ...
        <div className={styles.heroInner}>
          <div>
            ...
            <div className={styles.heroActions}>
              ...
              {/* RT-243: Apple Sign-In UI (Google OAuth only for now — jmvalley.com workspace restriction) */}
              <button
                className={styles.btnSecondary}
                disabled
                title="Apple Sign-In coming soon — currently restricted to @jmvalley.com Google Workspace accounts"
                style={{ opacity: 0.5, cursor: 'not-allowed', display: 'flex', alignItems: 'center', gap: 7 }}
              >
