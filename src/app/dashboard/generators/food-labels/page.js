            ...
            {ALLERGENS.map(a => (
              <button
                ...
                style={{
                  ...
                  border: form.allergens.includes(a) ? '2px solid #134A7C' : '1px solid #e5e7eb',
                  background: form.allergens.includes(a) ? 'rgba(19,74,124,0.08)' : '#fff',
                  color: form.allergens.includes(a) ? '#134A7C' : '#6b7280',
