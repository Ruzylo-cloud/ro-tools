...
const SEARCH_ITEMS = [
  ...
  { label: 'Payroll Workbench', path: '/dashboard/tools/payroll', icon: '💵', keywords: 'payroll pay period wages tips' },
  { label: 'Stability Snapshot', path: '/dashboard/tools/stability-snapshot', icon: '🧱', keywords: 'stability snapshot role staffing' },
