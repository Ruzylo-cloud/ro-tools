...
export const changelog = [
  ...
  // ── v2.9.7 — April 9, 2026 ───────────────────────────────────────
  {
    ...
    date: '2026-04-09',
    category: 'bug_fix',
    title: 'Security: Drive Upload Size Cap',
    description: 'PDF uploads to Google Drive now enforce a 20MB maximum. Previously there was no server-side size limit.',
  },
  {
    version: 'v2.9.7',
    date: '2026-04-09',
    category: 'bug_fix',
    title: 'Security: L10 Scorecard Input Validation',
    description: 'The L10 week parameter is now validated as a positive integer to prevent path traversal. The all-stores view now requires DM or Admin role as documented.',
  },
  {
    version: 'v2.9.7',
    date: '2026-04-09',
    category: 'bug_fix',
    title: 'Security: Employee Document Path Sanitization',
    description: 'Document file names are now sanitized before saving to prevent directory traversal, and document uploads are capped at 20MB.',
  },
  {
    version: 'v2.9.7',
    date: '2026-04-09',
  ...
  // ── v2.9.3 — April 3, 2026 ───────────────────────────────────────
  {
    ...
    date: '2026-04-03',
    category: 'bug_fix',
    title: 'Fix Ctrl+K Search Shortcut Not Focusing Input',
    description: 'The searchRef was attached to the wrapper div instead of the search input. Calling focus() on a non-focusable div is a no-op, so Ctrl+K and "/" shortcuts never focused the search box. The ref is now on the input element directly.',
  },
  {
    version: 'v2.9.3',
    date: '2026-04-03',
  ...
  },
  {
    ...
    date: '2026-04-03',
    category: 'bug_fix',
    title: 'Fix Email Header Injection in Injury Report Submission',
    description: 'The email API passed the subject field directly into an RFC 2822 header without sanitization. A newline in the subject could inject arbitrary headers. The subject is now stripped of newlines and capped at 500 characters.',
  },
  {
    version: 'v2.9.3',
    date: '2026-04-03',
    category: 'bug_fix',
    title: 'Fix Draft Cleanup Never Running on App Startup',
    description: 'The auto-cleanup that removes expired 7-day form drafts from localStorage was silently failing. It looked for "rt-draft-" keys but drafts are stored under "ro-tools-draft-", and it checked a "._savedAt" field that does not exist — drafts use ".ts". Both bugs fixed.',
  },
  {
    version: 'v2.9.3',
    date: '2026-04-03',
    category: 'bug_fix',
    title: 'Fix Employee Name Field Missing Error State Visual',
    description: 'Validation errors on the Employee Name field (required) showed the text message below the input but the EmployeeSelect component ignored the hasError prop — no red border appeared. The input now shows a red border matching other required fields.',
  },
  {
    version: 'v2.9.3',
    date: '2026-04-03',
